...
public class GatewayApiNacosPublisher implements DynamicRulePublisher<List<ApiDefinitionEntity>> {
    ...
    @Override
    public void publish(String app, String ip, Integer port, List<ApiDefinitionEntity> rules) throws Exception {
        AssertUtil.notEmpty(app, "app name cannot be empty");
        if (rules == null) {
            return;
        }
        configService.publishConfig(app + "-" + port + NacosConfigUtil.GATEWAY_API_DATA_ID_POSTFIX,
